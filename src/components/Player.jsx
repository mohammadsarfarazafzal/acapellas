...
const Player = () => {
  ...
  window.addEventListener("load", () => {
    document.getElementById("volValue").value = 100;
  });
  ...
  return (
    <div className="h-[15%] w-full flex justify-center lg:gap-5 items-center border-t border-t-zinc-800">
      <div className="w-[33%] h-full hidden lg:flex pl-7 gap-2 items-center">
        ...
        <div className="flex-col text-[#121212] dark:text-white justify-center items-center">
          <div className="text-lg font-sans font-semibold">{track.name}</div>
          <div className="text-sm font-sans font-normal">
            <a
              className="flex items-center gap-1 text-[#646464] dark:text-slate-200"
              href={track.link}
              target="_blank"
            >
              Original
              <svg
                className="fill-[#646464] dark:fill-slate-200 h-3 w-3"
      ...
      <div className="h-full lg:w-auto w-full flex lg:flex-col flex-col-reverse p-3 gap-4">
        <div className="lg:h-[60%] h-[80%] flex lg:justify-center item-center lg:gap-9 gap-1">
          <div className="h-full flex flex-1 lg:hidden gap-2 items-center">
            ...
            <div className="flex-col text-[#121212] dark:text-white justify-center items-center">
              ...
              <div className="text-sm font-sans font-normal text-[#646464] dark:text-slate-200">
                <a
        ...
        <div className="h-[20%] flex justify-center items-center gap-2">
          <div className="text-sm font-sans font-normal text-[#121212] dark:text-white h-min">
          ...
          <div className="w-96 bg-transparent grid grid-cols-1 grid-rows-1 h-min">
            <span className="w-full h-1 rounded-sm cursor-pointer col-span-full row-span-full bg-[#708090] dark:bg-[#282828]">
              <span
                ref={seekBg}
                className="block h-full rounded-sm bg-[#121212] dark:bg-white"
              ></span>
            </span>
      ...
      <div className="h-full hidden lg:flex flex-1 pr-7 justify-end items-center gap-2">
        <svg
          ref={lowVol}
          onClick={() => unmute()}
          className="cursor-pointer dark:fill-[#e8eaed] fill-[#121212] hidden"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
          viewBox="0 -960 960 960"
          width="24px"
        ...
        <div className="w-24 bg-transparent grid grid-cols-1 grid-rows-1 h-min">
          <span className="w-full h-1 rounded-sm cursor-pointer col-span-full row-span-full bg-[#708090] dark:bg-[#282828]">
            <span ref={volBg} className="block h-full rounded-sm bg-[#121212] dark:bg-white"></span>
          </span>
